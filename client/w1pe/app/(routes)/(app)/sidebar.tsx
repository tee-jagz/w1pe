...
export default function Sidebar() {
    ...
    const buttonStyle = `w-full flex flex-row ${open ? "justify-start  space-x-5" : "justify-center"} text-lg`
    ...
    return (
        ...
        <aside className={`flex flex-col items-center justify-start ${open ? "w-1/6 min-w-48" : "w-[100px] min-w-32"} bg-accent max-w-64  h-max shadow-lg ml-2 mt-20 ${shadowColor} pt-5 pb-10`}>
            ...
            <nav className="flex flex-col items-start w-full">
                ...
                <Button className={buttonStyle} variant="link" onClick={() => router.push('/dashboard')}> <Sparkles className={iconStyle} /> <p className={textStyle}>Write</p></Button>
